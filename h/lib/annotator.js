  ...
  Annotator = (function(_super) {
    ...
    Annotator.prototype.findAnchorFromRangeSelector = function(target) {
      ...
      return {
        type: "text position",
        startPage: 0,
        start: (this.domMapper.getInfoForNode(normalizedRange.start)).start,
        endPage: 0,
        end: (this.domMapper.getInfoForNode(normalizedRange.end)).end,
        quote: currentQuote
      };
    };
    ...
    Annotator.prototype._physicallyAnchor = function(anchor) {
      var s, status, _k, _len2, _ref1;
      if (anchor.allRendered) {
        return;
      }
      _ref1 = this.physicalAnchoringStrategies;
      for (_k = 0, _len2 = _ref1.length; _k < _len2; _k++) {
        s = _ref1[_k];
      ...
      return console.log(anchor.virtual);
    };
