...
Range.BrowserRange = (function() {
  ...
  BrowserRange.prototype.normalize = function(root) {
    ...
    if (r.start === r.end && !r.startImg) {
      ...
      if (r.end.nodeValue.length > r.endOffset && !r.endImg) {
...
Annotator = (function(_super) {
  ...
  Annotator.prototype.getSerializedRange = function(selector) {
    return new Range.SerializedRange({
  ...
  Annotator.prototype.findAnchorFromRangeSelector = function(target) {
    ...
    normalizedRange = this.getSerializedRange(selector).normalize(this.wrapper[0]);
