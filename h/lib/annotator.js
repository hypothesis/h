...
(function() {
  ...
  Annotator = (function(_super) {
    ...
    function Annotator(element, options) {
      ...
      this._setupWrapper();
      if (!this.options.noDocAccess) {
        this._setupDocumentAccessStrategies();
      }
      this._setupViewer()._setupEditor();
      this._setupDynamicStyle();
      if (!(this.options.noScan || this.options.noDocAccess)) {
        this._scan();
      }
    ...
    Annotator.prototype.loadAnnotations = function(annotations) {
      ...
      if (annotations.length) {
        if (!(this.domMapper || this.options.noDocAccess)) {
          this._scan();
        }
        if (this.pendingScan != null) {
