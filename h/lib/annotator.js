...
// Generated by CoffeeScript 1.6.3
(function() {
  var $, Anchor, Annotator, Delegator, Highlight, LinkParser, Range, TextHighlight, TextRangeAnchor, Util, findChild, fn, functions, g, getNodeName, getNodePosition, gettext, simpleXPathJQuery, simpleXPathPure, util, _Annotator, _gettext, _i, _j, _len, _len1, _ref, _ref1, _t,
    __slice = [].slice,
  ...
  Anchor = (function() {
    ...
    Anchor.prototype.realize = function() {
      var page, pagesTodo, renderedPages, _k, _l, _len2, _ref1, _ref2, _results,
        _this = this;
      ...
      for (_l = 0, _len2 = pagesTodo.length; _l < _len2; _l++) {
        page = pagesTodo[_l];
        this.highlight[page] = this._createHighlight(page);
      }
      this.fullyRealized = renderedPages.length === this.endPage - this.startPage + 1;
      return this.annotator.publish('anchorRealized', this);
    };
    ...
    Anchor.prototype.virtualize = function(pageIndex) {
      ...
      return this.annotator.publish('anchorVirtualized', this);
    };
  ...
  TextRangeAnchor = (function(_super) {
    ...
    TextRangeAnchor.getRangeSelector = function(annotator, range) {
      var sr;
    ...
    TextRangeAnchor.getTextQuoteSelector = function(annotator, range) {
      ...
      quote = annotator.domMapper.getCorpus().slice(startOffset, +(endOffset - 1) + 1 || 9e9).trim();
      _ref1 = annotator.domMapper.getContextForCharRange(startOffset, endOffset), prefix = _ref1[0], suffix = _ref1[1];
      return {
    ...
    TextRangeAnchor.getTextPositionSelector = function(annotator, range) {
    ...
    TextRangeAnchor.getTargetFromRange = function(annotator, range) {
      return {
        source: annotator.getHref(),
        selector: [TextRangeAnchor.getRangeSelector(annotator, range), TextRangeAnchor.getTextQuoteSelector(annotator, range), TextRangeAnchor.getTextPositionSelector(annotator, range)]
      };
    };
  ...
  Highlight = (function() {
    function Highlight(annotator, annotation, pageIndex) {
      this.annotator = annotator;
      this.annotation = annotation;
  ...
  TextHighlight = (function(_super) {
    ...
    TextHighlight.prototype.removeFromDocument = function() {
      var child, hl, _k, _len2, _ref1, _results;
      _ref1 = this._highlights;
      _results = [];
      for (_k = 0, _len2 = _ref1.length; _k < _len2; _k++) {
        hl = _ref1[_k];
  ...
  Annotator = (function(_super) {
    ...
    Annotator.prototype._setupAnchoringStrategies = function() {
    ...
    Annotator.prototype.createAnchorFromRangeSelector = function(annotation, target) {
    ...
    Annotator.prototype.createAnchorFromPositionSelector = function(annotation, target) {
    ...
    Annotator.prototype.checkForEndSelection = function(event) {
      var container, r, range, selectedRanges, _k, _len2;
      this.mouseIsDown = false;
      if (this.ignoreMouseup) {
        return;
      }
      selectedRanges = this.getSelectedRanges();
      for (_k = 0, _len2 = selectedRanges.length; _k < _len2; _k++) {
        range = selectedRanges[_k];
      ...
      this.selectedTargets = (function() {
        ...
        _results = [];
        for (_l = 0, _len3 = selectedRanges.length; _l < _len3; _l++) {
          r = selectedRanges[_l];
          _results.push(TextRangeAnchor.getTargetFromRange(this, r));
        }
        return _results;
      }).call(this);
