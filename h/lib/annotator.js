...
(function() {
  ...
  Annotator = (function(_super) {
    ...
    Annotator.prototype._setupVirtualAnchoringStrategies = function() {
      return this.virtualAnchoringStrategies = [
        {
          name: "range",
    ...
    Annotator.prototype._setupPhysicalAnchoringStrategies = function() {
      return this.physicalAnchoringStrategies = [
        {
          name: "Text position",
    ...
    Annotator.prototype._setupPhysicalUnAnchoringStrategies = function() {
      return this.physicalUnAnchoringStrategies = [
        {
          name: "Range",
    ...
    Annotator.prototype._physicallyAnchor = function(anchor) {
      var pAnchor, pagesTodo, renderedPages, s, status, vAnchor, _k, _l, _len2, _ref1, _ref2, _ref3, _results,
        _this = this;
      ...
      _ref3 = this.physicalAnchoringStrategies;
    ...
    Annotator.prototype._physicallyAnchorToTextPosition = function(anchor) {
    ...
    Annotator.prototype._physicallyUnAnchor = function(anchor, pageIndex) {
      var data, s, status, _k, _len2, _ref1;
    ...
    Annotator.prototype._physicallyUnAnchorFromRange = function(anchor, data, pageIndex) {
      var ann, child, hl, i, _k, _len2, _ref1, _ref2, _ref3;
      if (data.type !== "range") {
        return;
      }
