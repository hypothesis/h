...
(function() {
  ...
  TextHighlight = (function(_super) {
    ...
    TextHighlight.isInstance = function(element) {
      return annotator.Annotator.$(element).hasClass('annotator-hl');
    };

    TextHighlight.getIndependentParent = function(element) {
      return annotator.Annotator.$(element).parents(':not([class^=annotator-hl])')[0];
    };
    ...
    TextHighlight._init = function(annotator) {
      ...
      getAnnotations = function(event) {
        var annotations;
        return annotations = annotator.Annotator.$(event.target).parents('.annotator-hl').andSelf().map(function() {
          return annotator.Annotator.$(this).data("annotation");
        });
      };
    ...
    function TextHighlight(annotator, annotation, anchor, pageIndex, realRange) {
      ...
      annotator.Annotator.$(this._highlights).data("annotation", annotation);
    }
    ...
    TextHighlight.prototype.setTemporary = function(value) {
      ...
      if (value) {
        return annotator.Annotator.$(this._highlights).addClass('annotator-hl-temporary');
      } else {
        return annotator.Annotator.$(this._highlights).removeClass('annotator-hl-temporary');
      }
    };

    TextHighlight.prototype.setActive = function(value) {
      if (value) {
        return annotator.Annotator.$(this._highlights).addClass('annotator-hl-active');
      } else {
        return annotator.Annotator.$(this._highlights).removeClass('annotator-hl-active');
      }
    };
  ...
  TextRangeAnchor = (function(_super) {
    ...
    TextRangeAnchor.prototype._createHighlight = function(page) {
      ...
      return new TextHighlight(this.annotator, this.annotation, this, page, range);
    };
  ...
  Annotator.Plugin.TextAnchors = (function(_super) {
    ...
    TextAnchors.prototype._getSelectedRanges = function() {
      ...
      return annotator.Annotator.$.grep(ranges, function(range) {
        if (range) {
