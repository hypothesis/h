...
(function() {
  ...
  Annotator.Plugin.FuzzyAnchoring = (function(_super) {
    ...
    FuzzyAnchoring.prototype.twoPhaseFuzzyMatching = function(annotation, target) {
      ...
      return new this.annotator.Annotator.TextRangeAnchor(this.annotator, annotation, target, match.start, match.end, this.annotator.domMapper.getPageIndexForPos(match.start), this.annotator.domMapper.getPageIndexForPos(match.end), match.found, !match.exact ? match.comparison.diffHTML : void 0, !match.exact ? match.exactExceptCase : void 0);
    };

    FuzzyAnchoring.prototype.fuzzyMatching = function(annotation, target) {
