...
(function() {
  ...
  TextHighlight = (function(_super) {
    ...
    TextHighlight.prototype._publishChange = function(reason) {
      var event, node;
      event = document.createEvent("UIEvents");
      event.initUIEvent("domChange", true, false, window, 0);
      event.reason = reason;
      node = this.annotator.domMapper.getPageRoot(this.pageIndex);
    ...
    function TextHighlight(anchor, pageIndex, normedRange) {
      ...
      this._publishChange("created hilite");
    }
    ...
    TextHighlight.prototype.setTemporary = function(value) {
      ...
      return this._publishChange("hilite setTemporary()");
    };
    ...
    TextHighlight.prototype.setActive = function(value) {
      ...
      return this._publishChange("hilite setActive()");
    };

    TextHighlight.prototype.removeFromDocument = function() {
      var child, hl, _i, _len, _ref;
      ...
      return this._publishChange("removed hilite");
    };
