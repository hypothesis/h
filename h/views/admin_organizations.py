...
@view_config(
    route_name="admin_organizations",
    request_method="GET",
...
@view_defaults(
    route_name="admin_organizations_create",
...
class OrganizationCreateController(object):
    ...
    def get(self):
        self.form.set_appstruct({"authority": self.request.authority})
...
@view_defaults(
    route_name="admin_organizations_edit",
    permission="admin_organizations",
...
class OrganizationEditController(object):
    ...
    @view_config(request_method="POST", route_name="admin_organizations_delete")
    def delete(self):
        org = self.org
        ...
        return HTTPFound(location=self.request.route_path("admin_organizations"))
    ...
    def _template_context(self):
        ...
        if self.org.pubid != "__default__":
            delete_url = self.request.route_url(
                "admin_organizations_delete", pubid=self.org.pubid
            )
