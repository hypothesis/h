...
def features_save(request):
    ...
    return httpexceptions.HTTPSeeOther(location=request.route_url("admin_features"))


@view_config(
    route_name="admin_cohorts",
    request_method="GET",
