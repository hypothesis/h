...
class Environment(object):
    ...
    Static assets are grouped into named bundles, defined in a YAML
    config file. The relative URL that should be used when serving
    a file from a bundle is defined in a JSON manifest file, which
    is generated by the static asset build pipeline.
    ...
    def __init__(self, assets_base_url, bundle_config_path, manifest_path):
        ...
        self.bundles = _CachedFile(bundle_config_path, yaml.load)
