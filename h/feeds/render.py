...
def render_atom(request, annotations, atom_url, html_url, title, subtitle):  # noqa: PLR0913
    """
...
def render_rss(request, annotations, rss_url, html_url, title, description):  # noqa: PLR0913
    """
