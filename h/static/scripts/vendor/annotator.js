...
// Generated by CoffeeScript 1.6.3
(function() {
  var $, Annotator, Delegator, Highlight, LinkParser, Range, Util, findChild, fn, functions, g, getNodeName, getNodePosition, gettext, simpleXPathJQuery, simpleXPathPure, util, _Annotator, _gettext, _i, _j, _len, _len1, _ref, _t,
    __slice = [].slice,
  ...
  Highlight = (function() {
    function Highlight(anchor, pageIndex) {
      ...
      this.anchoring = this.anchor.anchoring;
      this.annotator = this.anchoring.annotator;
    }
  ...
  Annotator = (function(_super) {
    ...
    Annotator.prototype.setupAnnotation = function(annotation) {
      var anchor, exception, result, t, _k, _len2, _ref1, _ref2, _ref3;
      ...
      for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
        ...
        try {
          ...
          exception = _error;
          console.log("Error in setupAnnotation for", annotation.id, ":", (_ref3 = exception.stack) != null ? _ref3 : exception);
        }
      }
      return annotation;
    };
    ...
    Annotator.prototype.onEditorHide = function() {
      return this.publish('annotationEditorHidden', [this.editor]);
    };
    ...
    Annotator.prototype._getTargetFromSelection = function(selection) {
      return {
        source: this.getHref(),
        selector: this.anchoring.getSelectorsFromSelection(selection)
      };
    };
