...
(function() {
  ...
  TextHighlight = (function(_super) {
    ...
    TextHighlight.createFrom = function(segment, anchor, page) {
      if (segment.type !== "magic range") {
        return null;
      }
      return new TextHighlight(anchor, page, segment.data);
    };
    ...
    TextHighlight.prototype.removeFromDocument = function() {
      var child, document, event, hl, _i, _len, _ref, _results;
      document = this.anchoring;
      _ref = this._highlights;
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        hl = _ref[_i];
        if ((hl.parentNode != null) && this.anchoring.document.isPageMapped(this.pageIndex)) {
