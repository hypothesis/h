...
(function() {
  ...
  Annotator.Plugin.FuzzyTextAnchors = (function(_super) {
    ...
    FuzzyTextAnchors.prototype.twoPhaseFuzzyMatching = function(annotation, target) {
      var document, expectedEnd, expectedStart, match, options, posSelector, prefix, quote, quoteSelector, result, suffix;
    ...
    FuzzyTextAnchors.prototype.fuzzyMatching = function(annotation, target) {
      var document, expectedStart, len, match, options, posSelector, quote, quoteSelector, result;
      document = this.anchoring.document;
      if (document.getInfoForNode == null) {
        return;
      }
