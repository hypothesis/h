...
(function() {
  ...
  Annotator.Plugin.PDF = (function(_super) {
    ...
    PDF.prototype._getDocumentURI = function() {
      ...
      if (uri.slice(0, 16) === "chrome-extension") {
        return uri.slice(52);
      } else {
        return uri;
      }
    ...
    PDF.prototype._getTitle = function() {
      var title;
      title = PDFView.documentInfo.Title.trim();
      if (title !== "") {
        return title;
      } else {
