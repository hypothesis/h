...
import type { SignupWithGoogleConfigObject } from '../config';

export default function SignupWithGoogleForm() {
  const config = useContext(Config) as SignupWithGoogleConfigObject;
  const googleId = config.identity.provider_unique_id;
