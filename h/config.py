...
SETTINGS = [
    ...
    DockerSetting('nsqd.reader.addresses', 'nsqd',
                  pattern='{port_4150_tcp_addr}:{port_4150_tcp_port}'),
    DockerSetting('nsqd.writer.address', 'nsqd',
                  pattern='{port_4151_tcp_addr}:{port_4151_tcp_port}'),
    ...
    EnvSetting('nsq.namespace', 'NSQ_NAMESPACE'),
    EnvSetting('nsqd.reader.addresses', 'NSQ_READER_ADDRS'),
    EnvSetting('nsqd.writer.address', 'NSQ_WRITER_ADDR'),
