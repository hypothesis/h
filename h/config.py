...
def configure(environ=None, settings=None):  # noqa: PLR0915
    ...
    settings_manager.set("oidc_authorizationurl_google", "OIDC_AUTHORIZATIONURL_GOOGLE")
    settings_manager.set("oidc_tokenurl_google", "OIDC_TOKENURL_GOOGLE")
    settings_manager.set("oidc_keyseturl_google", "OIDC_KEYSETURL_GOOGLE")
