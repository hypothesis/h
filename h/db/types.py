...
class URLSafeUUID(types.TypeDecorator):
    ...
    def url_safe_to_hex(cls, value):
        ...
        if not isinstance(value, str):
            raise InvalidUUID(f"`url_safe` is {type(value)}, expected str")  # noqa: EM102, TRY003
        ...
        try:
            ...
            raise InvalidUUID(f"{value!r} is not a valid encoded UUID") from err  # noqa: EM102, TRY003
        ...
        raise InvalidUUID(f"{value!r} is not a valid encoded UUID")  # noqa: EM102, TRY003
...
def _transform_quote_selector(selectors, transform_func):  # pragma: no cover
    ...
    for selector in selectors:
        ...
        if not selector.get("type") == "TextQuoteSelector":  # noqa: SIM201
            continue
