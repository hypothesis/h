...
class TestUpdateGroup(object):
    ...
    def test_it_returns_http_200_with_valid_payload_and_user_token(self, app, token_auth_header, first_party_group):
        ...
        res = app.patch_json('/api/groups/{id}'.format(id=first_party_group.pubid),
                             group,
    ...
    def test_it_does_not_update_group_if_empty_payload_and_user_token(self, app, token_auth_header, first_party_group):
        payload = {}
        res = app.patch_json('/api/groups/{id}'.format(id=first_party_group.pubid),
                             payload,
                             headers=token_auth_header)
    ...
    def test_it_ignores_non_whitelisted_fields_in_payload_and_user_token(self, app, token_auth_header, first_party_group):
        group = {
            'id': 'fbdzzz',
            'name': 'My Group',
            'organization': 'foobar',
    ...
    def test_it_returns_http_400_with_invalid_payload_and_user_token(self, app, token_auth_header, first_party_group):
        group = {
    ...
    def test_it_returns_http_400_if_groupid_set_on_default_authority_and_user_token(self, app, token_auth_header, first_party_group):
        group = {
            'groupid': '3434kjkjk',
        }
        res = app.patch_json('/api/groups/{id}'.format(id=first_party_group.pubid),
    ...
    def test_it_returns_http_404_if_token_user_unauthorized(self,
                                                            app,
                                                            token_auth_header,
                                                            factories,
                                                            db_session):
        ...
        res = app.patch_json('/api/groups/{id}'.format(id=group.pubid),
                             group_payload,
                             headers=token_auth_header,
                             expect_errors=True)
    ...
    def test_it_allows_auth_client_with_valid_forwarded_user(self,
                                                             app,
                                                             auth_client_header,
                                                             third_party_user,
                                                             factories,
