...
class TestGenerate(object):
    ...
    def html_renderer(self, pyramid_config):
        return pyramid_config.testing_add_renderer('h:templates/emails/flag_notification.html.jinja2')

    @pytest.fixture
    def text_renderer(self, pyramid_config):
        return pyramid_config.testing_add_renderer('h:templates/emails/flag_notification.txt.jinja2')
