...
def test_includeme():
    ...
    assert config.add_route.mock_calls == [
        ...
        call('annotation', '/a/{id}', factory='h.resources:AnnotationRoot', traverse='/{id}'),
        call('stream', '/stream'),
        ...
        call('api.group_member', '/api/groups/{pubid}/members/{user}', factory='h.resources.GroupRoot', traverse='/{pubid}'),
        ...
        call('group_edit', '/groups/{pubid}/edit', factory='h.resources.GroupRoot', traverse='/{pubid}'),
        call('group_read', '/groups/{pubid}/{slug:[^/]*}', factory='h.resources.GroupRoot', traverse='/{pubid}'),
        call('group_read_noslug', '/groups/{pubid}', factory='h.resources.GroupRoot', traverse='/{pubid}'),
        call('help', '/docs/help'),
