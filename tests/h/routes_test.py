...
def test_includeme():
    ...
    assert config.add_route.mock_calls == [
        ...
        call('api.group_member', '/api/groups/{pubid}/members/{user}', factory='h.resources.GroupFactory', traverse='/{pubid}'),
        ...
        call('group_read', '/groups/{pubid}/{slug:[^/]*}', factory='h.resources.GroupFactory', traverse='/{pubid}'),
        call('group_read_noslug', '/groups/{pubid}', factory='h.resources.GroupFactory', traverse='/{pubid}'),
        call('help', '/docs/help'),
