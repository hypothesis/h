...
class TestExecute(object):
    ...
    def test_it_creates_a_search_query(self, pyramid_request, Search):
        ...
        Search.assert_called_once_with(pyramid_request, stats=pyramid_request.stats)
    ...
    def test_it_only_shows_annotations_from_current_authority(
    ...
    def search(self, annotations):
        search = mock.Mock(spec_set=["append_filter", "append_aggregation", "run"])
