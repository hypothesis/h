...
class TestIndex(object):
    @pytest.mark.parametrize('query,expected_orgs', [
    ...
    def test_it_returns_filtered_orgs(self, orgs, pyramid_request, query, expected_orgs):
        if query:
    ...
    def orgs(self, factories):
        return [factories.Organization(name='BioPub'),
...
class TestOrganizationEditController(object):
    ...
    def _expected_form(self, org):
        return {'authority': org.authority,
                'logo': org.logo,
                'name': org.name}
