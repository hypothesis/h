...
@pytest.mark.usefixtures('routes', 'user_svc', 'oauth_provider')
class TestOAuthAuthorizeController(object):
    ...
    def oauth_provider(self, pyramid_config, auth_client):
        oauth_server = mock.create_autospec(OAuthProviderService)
        ...
        svc = oauth_server(oauth_validator=mock.Mock(), user_svc=mock.Mock(), domain='example.com')
