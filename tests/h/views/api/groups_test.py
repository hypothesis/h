...
class TestUpdateGroup(object):
    ...
    def test_it_inits_group_update_schema(self, pyramid_request, group, UpdateGroupAPISchema):
        views.update(group, pyramid_request)

        UpdateGroupAPISchema.return_value.validate.assert_called_once_with({})

    def test_it_passes_request_params_to_group_update_service(self,
                                                              group,
                                                              pyramid_request,
...
class TestUpsertGroup(object):
    ...
    def test_it_proxies_to_create_if_group_empty(self, pyramid_request, create, GroupUpsertContext):
    ...
    def test_it_does_not_proxy_to_create_if_group_extant(self, pyramid_request, create, group, GroupUpsertContext):
    ...
    def GroupUpsertContext(self):
        def context_factory(group, request):
            return mock.create_autospec(traversal.GroupUpsertContext, instance=True, group=group)
